...
│   │   ├── parser_generator.py   # 语法分析器生成器 [SDT实现]
...
## 项目类图
![项目架构图](docs/compiler.drawio.svg)

## 📚 详细文档

- **[SDT实现说明](docs/SDT实现说明.md)** - 语法制导翻译的详细实现和答辩要点  
- **[修改总结](docs/修改总结.md)** - SDT改造过程和关键改进  
- **[项目评估报告](docs/项目评估报告.md)** - 完整的项目评估和符合性分析  
- **[测试报告](docs/测试报告.md)** - 完整的测试结果和SDT验证  
- **[快速开始](docs/QUICKSTART.md)** - 项目快速入门指南
